...
static uint8_t g_8x8_font[256][8] =
    {
...
static uint8_t g_8x16_font[256][16] =
    {
...
static uint8_t g_80x25_text_palette[][3] = {
    {0, 0, 0},
    {0, 0, 42},
    {0, 42, 0},
    {0, 42, 42},
...
static void write_palette(uint8_t palette[256][3])
{
