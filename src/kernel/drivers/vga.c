...
_Static_assert(sizeof(g_8x16_font) == 256 * 16, "g_8x16_font must be 4096 bytes");
/*****************************************************************************
DAC PALETTES
*****************************************************************************/

static const uint8_t g_320x200x256_palette[256][3] __attribute__((aligned(16), section(".rodata"))) = {
    {0, 0, 0},
    {0, 0, 42},
    {0, 42, 0},
    {0, 42, 42},
...
static const uint8_t g_80x25_text_palette[][3] __attribute__((aligned(16), section(".rodata"))) = {
    {0, 0, 0},
    {0, 0, 42},
    {0, 42, 0},
    {0, 42, 42},
