...
void mouse_playground_main(void)
{
    ...
    register_ui_element(0,
                        {
                            .ctx = NULL,
                            .bound = [](uint16_t x, uint16_t y, void *ctx) -> bool_t
                            {
                            ...
                            .mouse2_handler = [](uint16_t x, uint16_t y, void *ctx) -> void
                            {
                                put_string(80 * 25 / 2 - strlen(m1_text) / 2, m2_text);
                            },
                            .mouse3_handler = [](uint16_t x, uint16_t y, void *ctx) -> void
                            {
